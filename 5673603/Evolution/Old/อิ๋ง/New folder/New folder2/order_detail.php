...
$sql_order = "SELECT orderNumber,orderDate,requiredDate,shippedDate,customerNumber,customerName
    FROM view_order
...
$sql_products = " SELECT productCode,productName,quantityOrdered,priceEach,totalPrice
    FROM view_products123
